...
export default function WatchTVPage({ params}: Props) {
  ...
  console.log("WatchTVPage params:", params);
  console.log("WatchTVPage id:", id);
  console.log("WatchTVPage season:", season);
  console.log("WatchTVPage episode:", episode);

  return (
    <div className="p-4 md:p-8">
      <h1 className="text-2xl font-bold text-white mb-4">Now Watching</h1>
      <WatchPlayer id={id} type="tv" season={season} episode={episode} />
    </div>
  );
}
